...
(() => {
    ...
    function renderDashboardCards() {
        ...
        container.innerHTML = `
            <!-- Primary 4-Function Single Row Section -->
            <div class="four-column-row" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px; width: 100%; margin-bottom: 25px;">
                
                <!-- Function 1: Total Accounts -->
                <div class="dashboard-card function-card" style="background: #1e293b; padding: 15px; border-radius: 12px; text-align: center;">
                    <a href="https://tharahuokaing.github.io/total_account/" style="text-decoration: none; color: inherit; display: block; height: 100%; width: 100%;">
                        <img src="total_account.jpg" alt="Accounts Icon" class="card-icon" style="width:100px; height:100px; object-fit: cover; border-radius: 50%;">
                        <h3 id="accountCount" style="margin-top: 10px; font-size: 1.2rem;">$10,000</h3>
                        <p style="font-size: 0.85rem;">Total Accounts</p>
                        <span class="card-link" style="font-size: 0.75rem; color: #38bdf8;">View Details</span>
                    </a>
                </div>

                <!-- Function 2: Total Deposits -->
                <div class="dashboard-card function-card" style="background: #1e293b; padding: 15px; border-radius: 12px; text-align: center;">
                    <a href="https://tharahuokaing.github.io/deposit/" style="text-decoration: none; color: inherit; display: block; height: 100%; width: 100%;">
                        <img src="total_deposit.jpg" alt="Deposits Icon" class="card-icon" style="width:100px; height:100px; object-fit: cover; border-radius: 50%;">
                        <h3 id="depositTotal" style="margin-top: 10px; font-size: 1.2rem;">$600,050,000</h3>
                        <p style="font-size: 0.85rem;">Total Deposits</p>
                        <span class="card-link" style="font-size: 0.75rem; color: #38bdf8;">View Details</span>
                    </a>
                </div>

                <!-- Function 3: Transaction Volumes -->
                <div class="dashboard-card function-card" style="background: #1e293b; padding: 15px; border-radius: 12px; text-align: center;">
                    <a href="https://tharahuokaing.github.io/transaction/" style="text-decoration: none; color: inherit; display: block; height: 100%; width: 100%;">
                        <img src="transaction_volumn.jpg" alt="Transactions Icon" class="card-icon" style="width:100px; height:100px; object-fit: cover; border-radius: 50%;">
                        <h3 id="txCount" style="margin-top: 10px; font-size: 1.2rem;">$0</h3>
                        <p style="font-size: 0.85rem;">Transactions</p>
                        <span class="card-link" style="font-size: 0.75rem; color: #38bdf8;">View Log</span>
                    </a>
                </div>

                <!-- Function 4: System Phases -->
                <div class="dashboard-card function-card" style="background: #1e293b; padding: 15px; border-radius: 12px; text-align: center;">
                    <a href="https://tharahuokaing.github.io/total_phase/" style="text-decoration: none; color: inherit; display: block; height: 100%; width: 100%;">
                        <img src="system_phase.jpg" alt="Phases Icon" class="card-icon" style="width:100px; height:100px; object-fit: cover; border-radius: 50%;">
                        <h3 style="margin-top: 10px; font-size: 1.2rem;">21</h3>
                        <p style="font-size: 0.85rem;">Total Phases</p>
                        <span class="card-link" style="font-size: 0.75rem; color: #38bdf8;">View Map</span>
                    </a>
                </div>

            </div>

            <!-- Remaining Dashboard Grid Cards -->
