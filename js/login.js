...
(() => {
    ...
    const USERS = [
        ...
        { username: "test2", password: "test2", role: "Customer", requires2FA: false },
    ...
    function initializeDashboardData() {
        ...
        if (document.getElementById("accountCount")) {
            document.getElementById("accountCount").textContent = "60,000";
            document.getElementById("depositTotal").textContent = "$1,152,910,000";
        ...
        container.innerHTML = `
            <div class="dashboard-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 15px;">
                ...
                <div class="dashboard-card">
                    ...
                    <h3 id="depositTotal">$1,152,910,000</h3>
                    <p>Total Deposits</p>
