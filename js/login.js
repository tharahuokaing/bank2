...
(() => {
    ...
    function initializeDashboardData() {
        ...
        if (document.getElementById("accountCount")) {
            document.getElementById("accountCount").textContent = "$10000";
            document.getElementById("depositTotal").textContent = "$10,050,000";
        ...
        container.innerHTML = `
            <div class="dashboard-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 15px;">
                ...
                <div class="dashboard-card">
                    ...
                    <h3 id="depositTotal">$10,050,000</h3>
                    <p>Total Deposits</p>
